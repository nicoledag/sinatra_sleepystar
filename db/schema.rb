...
ActiveRecord::Schema.define(version: 2019_03_12_151810) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "babies", id: :serial, force: :cascade do |t|
    t.string "name"
    t.integer "user_id"
  ...
  create_table "planners", id: :serial, force: :cascade do |t|
    t.string "wake_time"
    t.string "bed_time"
    t.integer "baby_id"
    t.datetime "created_at", null: false
