...
nicole = User.create(username: "Nicole", password_digest: "hello767")
sara = User.create(username: "Sara", password_digest: "whatsup944")
...
julie_tuesday = Planner.new(day: "Tuesday", wake_time: "8:30am", bed_time: "8:30pm")

alec_monday = Planner.create(day: "Monday", wake_time: "7:30am", bed_time: "8pm")
alec_tuesday = Planner.new(day: "Tuesday", wake_time: "7:30am", bed_time: "8pm")

kristi_monday = Planner.create(day: "Monday", wake_time: "6:30am", bed_time: "7pm")
kristi_tuesday = Planner.new(day: "Tuesday", wake_time: "6:30am", bed_time: "7pm")
